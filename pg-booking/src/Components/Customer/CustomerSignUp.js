...
class CustomerSignUp extends React.Component {
    ...
    onSubmit = (e) => {
        ...
        if(UserObj.email === '' || UserObj.pass === ''){
            ...
            axios.get('http://localhost:4000/customers/ValUserSignUp/'+ UserObj.email + '/' + UserObj.phone)
            .then((res) =>{
                if(res.data === 'new'){
                    axios.post('http://localhost:4000/customers/CreateUser', UserObj
                    ).then((res) => {                        
                        ...
                        <div>
                            <form onSubmit = {this.onSubmit}>
                                ...
                                <div>
                                    ...
                                    <Button variant ="light"><Link to="/CustomerSignIn">Sign In</Link></Button>
                                </div>
                            </form>
                        </div>   
                    </Jumbotron>         
